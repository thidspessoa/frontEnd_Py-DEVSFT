...
j = str(input("Digite o tipo de pessoa: "))

#Input com estrutura de repetição
s = [] #iniciamos como lista pois tuplas não podem ser mudadaas de tamanho, e apos isso convertemos em tupla.
while True:
    sal = float(input("salário: "))
    s.append(sal)
    encerrar = int(input("Ainda tem salário? 1-sim, 2-não"))
    if (encerrar == 1):
        continue
    else:
        tupla = tuple(s)#transforma em tupla
        print(tupla) 
        break
...
if (j == "Fisica" or j == "fisica"):
    x = str(input("Digite o CPF: "))         
    pessoa2 = PessoaFisica(n, c, x)
    print(pessoa2.mensagem())
    print(pessoa2.get_nome())
    print(pessoa2.get_idade())
    print(pessoa2.CPF)
    print(pessoa2.calculoImposto(tupla))
    
elif (j == "Juridica" or j == "juridica"):
    y = str(input("Digite o CNPJ: "))
    i = str(input("Digite o porte da empresa: "))
    pessoa3 = PessoaJuridica(n, c, y)
    print(pessoa3.mensagem())
    print(pessoa3.get_nome())
    print(pessoa3.get_idade())
    print(pessoa3.CNPJ)
    print(pessoa3.calculoImposto(tupla, i))



"""
print(pessoa1.get_nome()) #encapsulamento
print(pessoa1.set_idade(22)) #encapsulamento
